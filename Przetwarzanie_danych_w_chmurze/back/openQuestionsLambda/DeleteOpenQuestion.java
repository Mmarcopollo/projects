...
public class DeleteOpenQuestion implements RequestHandler<Object, String> {
	...
	public String handleRequest(Object input, Context context) {
		...
		item_values.put("oq_id", new AttributeValue(mapa.get("oq_id").toString()));

		AmazonDynamoDB ddb = AmazonDynamoDBClientBuilder.standard().withRegion(Regions.US_EAST_1).build();
		ddb.deleteItem("openQuestions", item_values);
